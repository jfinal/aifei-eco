...
public class Redis {
	...
	public static <T> T callback(Callback<T> callback) {
		return callback(use(), callback);
	}
	
	public static <T> T callback(String cacheName, Callback<T> callback) {
		return callback(use(cacheName), callback);
	}
	
	private static <T> T callback(Cache cache, Callback<T> callback) {
